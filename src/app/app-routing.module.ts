    ...
    children: [
      {
        ...
        canActivate: [AuthGuard],
        data: { role: 'ADMIN' } // Protegido por rol
      },
      {
        path: 'reportes', loadChildren: () => import('./modules/reporte/module').then(m => m.Module),
      ...
      { path: 'clientes', loadChildren: () => import('./modules/GestionarPersona/Cliente/cliente.module').then(m => m.ClienteModule) },
      { path: 'doctores', loadChildren: () => import('./modules/GestionarPersona/Doctor/module').then(m => m.Module) },
      { path: 'pacientes', loadChildren: () => import('./modules/GestionarPersona/Paciente/module').then(m => m.Module) },
      { path: 'citasmedicas', loadChildren: () => import('./modules/GestionarHealthCare/CitaMedica/module').then(m => m.Module) },
      { path: 'recetas', loadChildren: () => import('./modules/GestionarHealthCare/Receta/module').then(m => m.Module) },
      { path: 'ventas', loadChildren: () => import('./modules/GestionarVenta/Venta/module').then(m => m.Module) },
      { path: 'pagos', loadChildren: () => import('./modules/GestionarVenta/Pago/module').then(m => m.Module) },
      { path: 'medicamentos', loadChildren: () => import('./modules/GestionarFarmacia/Medicamento/module').then(m => m.Module) },
      { path: 'dispensacion', loadChildren: () => import('./modules/GestionarFarmacia/Dispensacion/module').then(m => m.Module) },
      { path: 'generarcobro', loadChildren: () => import('./modules/GestionarFarmacia/Dispensacion/generarcobro.module').then(m => m.GenerarCobroModule) },
      { path: 'calendar', loadChildren: () => import('./modules/GestionarHealthCare/Calendar/calendar.module').then(m => m.CalendarModule) },
    ]
  },
  {
    path: 'login',
